   ...
   return (
      <div className='mt-10 padding-x '>
         ...
         <div className='flex items-center justify-between'>
            {/* Heading */}
            <div>
               <p className='typography-h3-semi-bold text-text-500'>Electricity Regulatory Commission Rules, 2018</p>
            </div>
         ...
         <div className='mt-3.5'>
            <p className='typography-p-regular-medium text-text-300'>Published Date : September 6, 2018</p>
         </div>
      </div>
   )
}
